...
class Base64OutputStream extends OutputStream
{
	 ...
	 *            The underlying stream.
	 */
	public Base64OutputStream(OutputStream outputStream, String chars, char pad)
	{
		this(outputStream, 76, chars, pad);
	}
	...
	protected void commit() throws IOException
	{
		if (bytecounter > 0)
		{
			...
			char b3 = (bytecounter < 2) ? pad : chars
					.charAt((buffer << 20) >>> 26);
			char b4 = (bytecounter < 3) ? pad : chars
					.charAt((buffer << 26) >>> 26);
